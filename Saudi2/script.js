...
const translations = {
    ar: {
        ...
        'footer.link.yas': 'جزيرة ياس',
        'footer.link.makkah': 'مكة المكرمة',
        'footer.link.umrah': 'عمرة VVIP',
        'footer.link.learn': 'تعلم اللغة العربية',
        'footer.link.disney': 'ديزني لاند باريس',
    ...
    en: {
        ...
        'footer.link.yas': 'Yas Island',
        'footer.link.makkah': 'Makkah',
        'footer.link.umrah': 'Umrah VVIP',
        'footer.link.learn': 'Learn Arabic',
        'footer.link.disney': 'Disneyland Paris',
        'footer.phone': '+966 920 019 190',
        'footer.email': 'CC@ATTC.SA',
