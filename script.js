...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('%c🏝️ Yas Island Landing Page - Ready!', 'color: #F7A716; font-size: 16px; font-weight: bold;');
});
...
function initLanguageToggle() {
    ...
    langToggle.addEventListener('click', function() {
        ...
        // Reinitialize sliders to fix image visibility when language changes
        setTimeout(() => {
            // Force reset all sliders to show first image
